...
.spotlight .banner-logo{position:absolute;left:50%;top:45%;transform:translate(-50%,-50%);max-width:60%;max-height:50%;object-fit:contain;z-index:15;filter:drop-shadow(0 6px 20px rgba(0,0,0,.95)) drop-shadow(0 0 40px rgba(0,0,0,.6)) drop-shadow(0 0 1px rgba(255,255,255,.6));pointer-events:auto;cursor:pointer;transition:transform .5s ease,opacity .3s ease,filter .3s ease}
.spotlight-container:hover .banner-logo{transform:translate(-50%,-50%) scale(1.1);filter:drop-shadow(0 8px 24px rgba(0,0,0,.95)) drop-shadow(0 0 40px rgba(0,0,0,.6)) drop-shadow(0 0 2px rgba(255,255,255,.8))}
